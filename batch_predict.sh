...
project_name=cycle_normal_decay_batch8
python -m src.contour_flow_main --predict_on=custom:/data/junbong/optical_flow/assets/pc_5small_dense_matlab_seg_all_points/tfrecord/test1/ --generated_dir=/data/junbong/optical_flow/generated_3_5_2023/pc_5small_dense_matlab_seg_all_points_$project_name/  --use_seg_points --use_tracking_points
python -m src.contour_flow_main --predict_on=custom:/data/junbong/optical_flow/assets/pc_5small_dense_matlab_seg_all_points/tfrecord/test2/ --generated_dir=/data/junbong/optical_flow/generated_3_5_2023/pc_5small_dense_matlab_seg_all_points_$project_name/  --use_seg_points --use_tracking_points
python -m src.contour_flow_main --predict_on=custom:/data/junbong/optical_flow/assets/pc_5small_dense_matlab_seg_all_points/tfrecord/test3/ --generated_dir=/data/junbong/optical_flow/generated_3_5_2023/pc_5small_dense_matlab_seg_all_points_$project_name/  --use_seg_points --use_tracking_points --width=576 --height=544
python -m src.contour_flow_main --predict_on=custom:/data/junbong/optical_flow/assets/pc_5small_dense_matlab_seg_all_points/tfrecord/test4/ --generated_dir=/data/junbong/optical_flow/generated_3_5_2023/pc_5small_dense_matlab_seg_all_points_$project_name/  --use_seg_points --use_tracking_points --width=384 --height=480
