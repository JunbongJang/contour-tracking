...
Please find the files used in this section inside the preprocessing folder. <br>
Run the following pre-processing files in order as indicated by the number.
...
2. To create pseudo labels from the tracking results generated by **[MATLAB morphodynamic profiler](https://github.com/DanuserLab/Windowing-Protrusion)**, run
