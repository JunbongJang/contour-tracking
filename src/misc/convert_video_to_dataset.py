...
flags.DEFINE_string('output_filename', 'fvideo@1', 'filename of the video dataset.')
...
def convert_video(video_file_path, output_folder, output_filename):
...
def main(unused_argv):
  convert_video(FLAGS.video_path, FLAGS.output_path, FLAGS.output_filename)
