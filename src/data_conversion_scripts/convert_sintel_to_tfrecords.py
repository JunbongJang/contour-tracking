...
def convert_dataset():
  ...
  for data_split in ['training']: # ['training', 'test']:
    ...
    for data_type in ['segmentation']: # ['clean', 'final']:
      ...
      image_folders = sorted(tf.io.gfile.glob(input_folder + '/*'))  # ['uflow/assets/mpi_sintel/training/clean/alley_1', 'uflow/assets/mpi_sintel/training/clean/alley_2', ...]
